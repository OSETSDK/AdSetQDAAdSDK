...
@class AdSetQDAMediaInfo;


@interface AdSetQDAAdMaterial : NSObject

/// 素材 id
@property(nonatomic,copy)NSString *materialId;
/// 广告主图
@property(nonatomic,strong)AdSetQDAMediaInfo *image;
/// 广告标题  可能为空
...
/// 广告图片集合 用于多图信息流
@property(nonatomic,copy)NSArray<AdSetQDAMediaInfo *> *images;
@property(nonatomic,strong)AdSetQDAMediaInfo *videoAdInfo;
/// 点击按钮文案
